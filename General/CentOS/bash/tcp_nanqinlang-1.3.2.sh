...
install_devel(){
	...
	[[ ! -f kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://raw.githubusercontent.com/forevergooe/CentOS-kernel/master/kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
install_headers(){
	...
	[[ ! -f kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://raw.githubusercontent.com/forevergooe/CentOS-kernel/master/kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
compile(){
	wget https://raw.githubusercontent.com/forevergooe/general/master/General/CentOS/source/tcp_nanqinlang.c
	wget -O Makefile https://raw.githubusercontent.com/forevergooe/general/master/Makefile/Makefile-CentOS
	make && make install
}
